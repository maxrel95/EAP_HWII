...
fpmg1 <- pmg(er ~  1  + logbm + logme + reversal + mom, dataTable, index=c("jdate","permno"), )
...
fm_a_full_er <- pmg(er ~ 1 + GP + gat + logbm + logme + reversal + mom, df_a_full, index=c("jdate","permno") )
summary( fm_a_full_er )

# same basis as quarterly 
df_a_full_filtered = df_a_full %>%
  filter( jdate >='1975-07-30' )
fm_a_full_filtered <- pmg(er ~ 1 + GP + gat + logbm + logme + reversal + mom, df_a_full_filtered, index=c("jdate","permno") )
summary( fm_a_full_filtered )

# Full annually with ff3
df_a_full$residff3 = df_a_full$residff3*100
fm_a_full_ff3 <- pmg(residff3 ~ 1 + GP + gat + logbm + logme + reversal + mom, df_a_full, index=c("jdate","permno") )
summary( fm_a_full_ff3 )

# Full annually with ff3
df_a_full$residff6 = df_a_full$residff6*100
fm_a_full_ff6 <- pmg(residff6 ~ 1 + GP + gat + logbm + logme + reversal + mom, df_a_full, index=c("jdate","permno") )
...
gp_logme <- pmg(er ~ 1 + GP + gat + logbm + logme + reversal + mom + GP*logme, interaction_df, index=c("jdate","permno") )
gp_reversal <- pmg(er ~ 1 + GP + gat + logbm + logme + reversal + mom + GP*reversal, interaction_df, index=c("jdate","permno") )
gp_mom <- pmg(er ~ 1 + GP + gat + logbm + logme + reversal + mom + GP*mom, interaction_df, index=c("jdate","permno") )

gat_logbm <- pmg(er ~ 1 + GP + gat + logbm + logme + reversal + mom + gat*logbm, interaction_df, index=c("jdate","permno") )
gat_logme <- pmg(er ~ 1 + GP + gat + logbm + logme + reversal + mom + gat*logme, interaction_df, index=c("jdate","permno") )
gat_reversal <- pmg(er ~ 1 + GP + gat + logbm + logme + reversal + mom + gat*reversal, interaction_df, index=c("jdate","permno") )
gat_mom <- pmg(er ~ 1 + GP + gat + logbm + logme + reversal + mom + gat*mom, interaction_df, index=c("jdate","permno") )

logbm_logme <- pmg(er ~ 1 + GP + gat + logbm + logme + reversal + mom + logbm*logme, interaction_df, index=c("jdate","permno") )
logbm_reversal <- pmg(er ~ 1 + GP + gat + logbm + logme + reversal + mom + logbm*reversal, interaction_df, index=c("jdate","permno") )
logbm_mom <- pmg(er ~ 1 + GP + gat + logbm + logme + reversal + mom + logbm*mom, interaction_df, index=c("jdate","permno") )

logme_reversal <- pmg(er ~ 1 + GP + gat + logbm + logme + reversal + mom + logme*reversal, interaction_df, index=c("jdate","permno") )
logme_mom <- pmg(er ~ 1 + GP + gat + logbm + logme + reversal + mom + logme*mom, interaction_df, index=c("jdate","permno") )
