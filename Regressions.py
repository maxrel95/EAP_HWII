...
r2_fm_ff3 = all_df.groupby('jdate').apply(fm, var=['GP', 'gat','logbm','logme','reversal','mom'], type='residff3').mean()
...
r2_fm_ff6 = all_df.groupby('jdate').apply(fm, var=['GP', 'gat','logbm','logme','reversal','mom'], type='residff6').mean()
...
r2_fm_q = df_q.groupby('jdate').apply(fm, var=['GP', 'gat','logbm','logme','reversal','mom']).mean()
print(res_q.summary)
...
r2_fm_mom = interaction_df.groupby('jdate').apply(fm_iteraction, formula="er ~ 1 + GP+gat+logbm+logme+reversal+mom + reversal*mom + mom*logbm").mean()
...
r2_fm_bm = interaction_df.groupby('jdate').apply(fm_iteraction, formula="er ~ 1 + GP+gat+logbm+logme+reversal+mom+ logbm*mom + logbm*logme").mean()
...
r2_fm_int = interaction_df.groupby('jdate').apply(fm_iteraction, formula="er ~ 1 + GP+gat+logbm+logme+reversal+mom + reversal*mom + logbm*mom + logbm*logme").mean()
print(res_int.summary)

interaction_df = all_df[ (all_df['szport']!='Micro') ]

fm_mom_nomic = FamaMacBeth.from_formula( "er ~ 1 + GP+gat+logbm+logme+reversal+mom + reversal*mom + mom*logbm", data=interaction_df)
res_mom_nomic = fm_mom_nomic.fit(cov_type='kernel')
r2_fm_mom_nomic = interaction_df.groupby('jdate').apply(fm_iteraction, formula="er ~ 1 + GP+gat+logbm+logme+reversal+mom + reversal*mom + mom*logbm").mean()
print(res_mom_nomic.summary)

fm_bm_nomic = FamaMacBeth.from_formula( "er ~ 1 + GP+gat+logbm+logme+reversal+mom+ logbm*mom + logbm*logme", data=interaction_df)
res_bm_nomic = fm_bm_nomic.fit(cov_type='kernel')
r2_fm_bm_nomic = interaction_df.groupby('jdate').apply(fm_iteraction, formula="er ~ 1 + GP+gat+logbm+logme+reversal+mom+ logbm*mom + logbm*logme").mean()
print(res_bm_nomic.summary)

fm_int_nomic = FamaMacBeth.from_formula( "er ~ 1 + GP+gat+logbm+logme+reversal+mom + reversal*mom + logbm*mom + logbm*logme", data=interaction_df)
res_int_nomic = fm_int_nomic.fit(cov_type='kernel')
r2_fm_int_nomic = interaction_df.groupby('jdate').apply(fm_iteraction, formula="er ~ 1 + GP+gat+logbm+logme+reversal+mom + reversal*mom + logbm*mom + logbm*logme").mean()
print(res_int_nomic.summary)

stats_all = all_df[ ['GP', 'gat', 'logbm', 'logme', 'reversal', 'mom']].describe( 
